...
public class Response implements Disposable {
    ...
    private ArrayList<Cinematic> cinematic_all;
    ...
    public ArrayList<Cinematic> getCinematic_all(){ return cinematic_all;}

    public void setCinematic_all(ArrayList<Cinematic> cinematic_all) {this.cinematic_all = cinematic_all;}
